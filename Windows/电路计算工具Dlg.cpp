...
BOOL CMyDlg::OnInitDialog()
{
	...
	// 高通滤波电阻单位
	m_ComboGaoTongLvBoDianZu.AddString("微欧 - μΩ (Microohm)");
	m_ComboGaoTongLvBoDianZu.AddString("毫欧 - mΩ  (Milliohm)");
	m_ComboGaoTongLvBoDianZu.AddString("欧姆 - Ω   (Ohm)");
	m_ComboGaoTongLvBoDianZu.AddString("千欧 - KΩ  (Kiloohm)");
	m_ComboGaoTongLvBoDianZu.AddString("兆欧 - MΩ  (Megaohm)");
	m_ComboGaoTongLvBoDianZu.AddString("吉欧 - GΩ  (Gigaohm)");
	m_ComboGaoTongLvBoDianZu.AddString("太欧 - TΩ  (Teraohm)");
	...
	// 高通滤波电容单位
	m_ComboGaoTongLvBoDianRong.AddString("飞法 - fF  (femtofarad)");
	m_ComboGaoTongLvBoDianRong.AddString("皮法 - pF  (picofarad)");
	m_ComboGaoTongLvBoDianRong.AddString("纳法 - nF  (nanofarad)");
	m_ComboGaoTongLvBoDianRong.AddString("微法 - μF (microfarad)");
	m_ComboGaoTongLvBoDianRong.AddString("毫法 - mF  (millifarad)");
	m_ComboGaoTongLvBoDianRong.AddString("法拉 - F   (Farad)");
	...
	// 高通截止频率单位
	m_ComboGaoTongLvBoPinLv.AddString("赫兹 - Hz  (hertz)");
	m_ComboGaoTongLvBoPinLv.AddString("千赫 - kHz (kilohertz)");
	m_ComboGaoTongLvBoPinLv.AddString("兆赫 - MHz (megahertz)");
	m_ComboGaoTongLvBoPinLv.AddString("吉赫 - GHz (gigahertz)");
	m_ComboGaoTongLvBoPinLv.AddString("太赫 - THz (terahertz)");
	m_ComboGaoTongLvBoPinLv.AddString("拍赫 - PHz (petahertz)");
	m_ComboGaoTongLvBoPinLv.AddString("艾赫 - EHz (exahertz)");
